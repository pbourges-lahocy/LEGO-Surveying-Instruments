...
This project was inspired by the excellent brick-built RTC prototypes created and publicly shown by **Mei Yee Lai from Leica Geosystems**.

As I could not find public Studio files or building instructions for those prototypes, I tried to reconstruct my own version from the publicly shared photos, identifying parts and experimenting with the assembly directly in BrickLink Studio.

This repository contains **my own Studio reconstruction and instructions**, not Mei Yee Lai's original files.
